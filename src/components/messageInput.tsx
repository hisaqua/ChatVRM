  ...
  if (overlay) {
    return (
      <div className="relative z-20 w-full px-8 pb-8">
        <div className="overlay-input-surface mx-auto max-w-md rounded-oval bg-gradient-to-b from-[rgba(11,20,32,0.9)] to-[rgba(7,14,24,0.88)] backdrop-blur-md border border-[rgba(173,242,255,0.18)] px-8 py-[10px]">
